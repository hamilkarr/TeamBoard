...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="${rootURL}/resources/css/write.css${version}"  />
		...
		<script type="text/javascript" src="${rootURL}/resources/js/form.js${version}"></script>
